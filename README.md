...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/opennavsurf-bag-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/opennavsurf-bag-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add bagpy libbaglib
# for installing globally
pixi global install bagpy libbaglib
```
...
It is possible to list all of the versions of `bagpy` available on your platform:
...
```
pixi search bagpy --channel conda-forge
```
